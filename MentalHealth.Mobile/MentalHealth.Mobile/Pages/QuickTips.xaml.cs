...
namespace MentalHealth.Mobile.Pages
{
    ...
    public partial class QuickTips : ContentPage
    {
        ...
        void Hide()
        {
            GeneralTipsPanel.IsVisible = false;
        ...
        private void GeneralTapGestureRecognizer_Tapped(object sender, EventArgs e)
        {
            var value = GeneralTipsPanel.IsVisible;
            Hide();
            GeneralTipsPanel.IsVisible = !value;
        }
